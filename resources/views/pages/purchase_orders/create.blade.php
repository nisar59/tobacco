                ...
                $.ajax({
                    ...
                    success: function (responce) {
                        var row = $("<tr>" +
                            ...
                            "<td class='text-center'><strong style='margin-left: 20px' class='label label-info'>$ </strong><input id='p_total_price_" + responce.id + "' type='text' name='p_total_price[]' value='" + responce.unit_price + "' class='p_total_price' readonly='readonly' style='border: 0!important;text-align:left;margin: 10px 0 10px 0 !important;' ></td>" +
