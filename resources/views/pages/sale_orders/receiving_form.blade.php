                ...
                <div class="block">
                    ...
                    <form action="{{url('sales/receivable/save')}}"
                        ...
                        <div class="col-md-12 form-group has-success">
                            <div class="col-md-10">
                                <select id="val_skill_customer_id" name="customer_id" class="form-control  customer-filters" required="required">
                                    <option value="">Select Supplier</option>
                                    @foreach($customers as $customer)
                                        <option @if($customer->customer_id == $selected_customer_id) selected @endif value="{{$customer->id}}"><strong>Customer Name:</strong> {{$customer->customer_name}} &nbsp;&nbsp;&nbsp; <strong>Receivables:</strong> {{$customer->diff_amount}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
