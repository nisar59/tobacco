                        ...
                        <div class="table-responsive">
                            <div class="block-options">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" placeholder="Search with phone" id="val_skill_contact_number" name="contact_number" class="form-control filters" required="required" style="margin-top: 3px;margin-right: 5px"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="block full">
            ...
            <div class="block-title">
                <div class="block-options pull-right">
                    <a href="{{url('supplier/create')}}" class="btn btn-alt btn-sm btn-primary" data-toggle="tooltip"
                       title="Add New Supplier"><i class="fa fa-plus"></i></a>
                    <a href="{{url('supplier/index')}}" class="btn btn-alt btn-sm btn-primary" data-toggle="tooltip"
