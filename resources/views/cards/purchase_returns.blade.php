            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active">
                    <a href="javascript:void(0)">
                        <span class="badge pull-right">{{$supplier->supplier_name}}</span>
                        <i class="fa fa-user fa-fw"></i> <strong>Name</strong>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <span class="badge pull-right">{{$supplier->contact_number}}</span>
                        <i class="fa fa-phone fa-fw"></i> <strong>Phone</strong>
                    </a>
                </li>
            </ul>
            <div class="block block-alt-noborder">
                <h3 class="sub-header">Purchase <strong>Info</strong></h3>
                <ul class="nav nav-pills nav-stacked">
                    <li class="active">
                        <a href="javascript:void(0)">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h2 class="modal-title"><i class="fa fa-pencil"></i> Add Returns Against Following Purchase</h2>
            </div>
            <!-- END Modal Header -->

            <!-- Modal Body -->
            <div class="modal-body">
                <form action="{{url('purchase/return/save')}}"
                      method="post" class="form-horizontal form-bordered">
                    <fieldset>
                        {{csrf_field()}}
                        <input type="hidden" id="purchase_return_id" name="purchase_id" value="">
                        <input type="hidden" id="sr_qty" value="">
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="purchase_return_qty">Return Quantity</label>
                            <div class="col-md-6">
                                <input type="number" id="purchase_return_qty" name="purchase_return_qty" class="form-control"
...
@section('script')
    ...
    <script type="text/javascript">
        function edit_config($this) {
            ...
            $('#purchase_return_id').val($this);
            $('#purchase_return_qty').val((detail_qty.val()-slr_qty.val()));

            $("input[name='purchase_return_qty']").prop('max',(detail_qty.val()-slr_qty.val()));
