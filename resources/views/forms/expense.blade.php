    ...
    <div class="col-md-12">
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2>@if(isset($model) && !empty($model->id)) Update @else Add New @endif Expense</h2>
            </div>
            <!-- END User Assist Title -->

            <!-- User Assist Content -->
            <form action="@if(isset($model) && !empty($model->id)) {{url('/expense/update')}} @else {{url('/expense/save')}} @endif"
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 form-group has-success">
                    <label class="col-md-3 control-label" for="val_skill_type">Expense Type</label>
                    <div class="col-md-9">
                        <select id="val_skill_type" name="type" class="form-control" required="required">
                            ...
                            @foreach($expenseType as $type)
                                <option @if(isset($model) && !empty($model->type) && $model->type == $type->value) selected="selected"
                                        @endif value="{{$type->value}}">{{$type->lable}}</option>
                            @endforeach
                        </select>
                        @if($errors->has('type'))
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 form-group has-success">
                    <label class="col-md-3 control-label" for="example-text-input2">Expense Date</label>
                    <div class="col-md-9">
                        @if(isset($model) && !empty($model->exp_date))
                            <input type="date" id="example-text-input2-exp_date" name="exp_date" class="form-control"
                                   ...
                                   title="Expense Date!" required="required">
                        @else
                            <input type="date" id="example-text-input2-exp_date" name="exp_date" class="form-control"
                                   placeholder="Please enter configuration name" data-toggle="tooltip"
                                   value=""
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 form-group has-success">
                    <label class="col-md-3 control-label" for="val_skill_payment_mode">Expense Mode</label>
                    <div class="col-md-9">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 form-group has-success">
                    <label class="col-md-3 control-label" for="val_skill_payment_mode">Expense Amount</label>
                    <div class="col-md-9">
