    ...
    <div class="col-md-12">
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2><strong>@if(isset($model) && !empty($model->id)) Update @else Add New @endif</strong> Customer</h2>
            </div>
            <!-- END User Assist Title -->

            <!-- User Assist Content -->
            <form action="@if(isset($model) && !empty($model->id)) {{url('/customer/update')}} @else {{url('/customer/save')}} @endif" method="post" class="form-horizontal form-bordered">
                {{csrf_field()}}
