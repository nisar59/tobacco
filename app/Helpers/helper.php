...
function AllPermissions()
{
    ...
    $role['purchases']=['view','add','edit','delete','supplier','product','payable','payable_store','return'];
    $role['customer']=['view','add','edit','delete','export'];
    $role['sales']=['view','add','edit','delete','customer','product','receivable','receivable_store','return'];
    $role['returns']=['purchase','sale','purchase_return','sale_return'];
